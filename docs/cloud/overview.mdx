...
Skip the setup. Run Ziro in the cloud at [app.ziro.ai](https://app.ziro.ai).
...
1. Sign up at [app.ziro.ai](https://app.ziro.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Ziro Cloud" icon="rocket" href="https://app.ziro.ai">
