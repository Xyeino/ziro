...
Ziro offers three scan modes to balance speed and thoroughness.

## Quick

```bash
ziro --target ./app --scan-mode quick
```
...
```bash
ziro --target ./app --scan-mode standard
```
...
```bash
ziro --target ./app --scan-mode deep
```
