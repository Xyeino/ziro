...
description: "Guide Ziro with custom testing instructions"
---
...
```bash
ziro --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
ziro --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
ziro --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Ziro prioritize the most valuable attack paths.
</Tip>
