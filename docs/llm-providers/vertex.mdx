...
description: "Configure Ziro with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Ziro with the vertex extra:

```bash
pipx install "ziro-agent[vertex]"
```

## Setup

```bash
export ZIRO_LLM="vertex_ai/gemini-3-pro-preview"
```
