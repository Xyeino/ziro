---
title: "Azure OpenAI"
description: "Configure Ziro with OpenAI models via Azure"
---

## Setup

```bash
export ZIRO_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `ZIRO_LLM` | `azure/<your-deployment-name>` |
...
```bash
export ZIRO_LLM="azure/gpt-5.4-deployment"
