...
hiddenimports = [
    ...
    'ziro.interface.cli',
    'ziro.interface.tui',
    'ziro.interface.utils',
    'ziro.interface.tool_components',
    'ziro.agents',
    'ziro.agents.base_agent',
    'ziro.agents.state',
    'ziro.agents.ZiroAgent',
    'ziro.llm',
    'ziro.llm.llm',
    'ziro.llm.config',
    'ziro.llm.utils',
    'ziro.llm.memory_compressor',
    'ziro.runtime',
    'ziro.runtime.runtime',
    'ziro.runtime.docker_runtime',
    'ziro.telemetry',
    'ziro.telemetry.tracer',
    'ziro.tools',
    'ziro.tools.registry',
    'ziro.tools.executor',
    'ziro.tools.argument_parser',
    'ziro.skills',
]
