...
lint:
	...
	poetry run pylint ziro/ --score=no --reports=no
	@echo "✅ Linting complete!"

type-check:
	@echo "🔍 Type checking with mypy..."
	poetry run mypy ziro/
	@echo "🔍 Type checking with pyright..."
	poetry run pyright ziro/
	@echo "✅ Type checking complete!"

security:
	@echo "🔒 Running security checks with bandit..."
	poetry run bandit -r ziro/ -c pyproject.toml
...
test-cov:
	...
	poetry run pytest -v --cov=ziro --cov-report=term-missing --cov-report=html
