...
_INSTALL_RECIPES: dict[str, str] = {
    ...
    # Mobile reverse engineering — use API to discover latest version (no hardcoded SemVer)
    "jadx": (
        "bash -c 'set -e; "
